...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <div className="flex flex-col md:px-16 justify-center items-center">
          <div className="flex flex-row text-5xl lg:text-6xl font-bold mb-12 w-full h-32 text-center bg-green-500 rounded-b-3xl md:rounded-b-full justify-center items-center">Water your Plants
            <Image src={Plant} alt={''} className='w-12 hidden md:block'/>
          </div>
          <div className='mb-12'>
            <div className='flex flex-col justify-center items-center'>
              <button id='water-button'
                className='w-36 border rounded-full p-4 
                bg-white transition-all ease-in-out duration-150 hover:bg-zinc-200 hover:border-green-400 hover:border-4 mb-4' onClick={handleButtonClick}>
            ...
            <div className='flex flex-col md:flex-row justify-center items-center mb-4 md:mb-10 lg:mb-0'>
              <div className='relative md:mr-20 mb-4 md:mb-0'>
                ...
                style={{boxShadow: '6px 6px 10px -1px rgba(0,0,0,0.15)'}}>
                  ...
                  style={{boxShadow: 'inset 4px 4px 6px -1px rgba(0,0,0,0.2),inset -4px -4px 6px -1px rgba(255,255,255,0.7), -0.5px -0.5px 0px rgba(255,255,255,1), 0.5px 0.5px 0px rgba(0,0,0,0.15), 0px 12px 10px -10px rgba(0,0,0,0.05)'}}>
                    <div className='text-center pt-2 m-0 font-bold'>Soil</div>
                    <div className='text-center m-0 font-bold'>Moisture</div>
                    <div className='text-center font-bold text-4xl text-[#936f48]'>{soilMois ? String((soilMois * 100).toFixed(1)) + '%' : ''}</div>
                  </div>
                </div>
              ...
              <div className='relative lg:mr-20'>
                ...
                style={{boxShadow: '6px 6px 10px -1px rgba(0,0,0,0.15)'}}>
                  <div className='rounded-full w-[120px] h-[120px]'
                  style={{boxShadow: 'inset 4px 4px 6px -1px rgba(0,0,0,0.2),inset -4px -4px 6px -1px rgba(255,255,255,0.7), -0.5px -0.5px 0px rgba(255,255,255,1), 0.5px 0.5px 0px rgba(0,0,0,0.15), 0px 12px 10px -10px rgba(0,0,0,0.05)'}}>
                    <div className='text-center pt-2 m-0 font-bold'>Air</div>
                    <div className='text-center m-0 font-bold'>Humidity</div>
                    <div className='text-center font-bold text-4xl text-[#002473]'>{airHu ? String((airHu * 100).toFixed(1)) + '%' : ''}</div>
                  </div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="160px" height="160px" className='absolute top-0 left-0'>
                  <defs>
            ...
            <div className='flex flex-col md:flex-row justify-center items-center'>
              <div className='md:mr-20 mb-4 md:mb-0'>
                <div className='w-40 h-40 bg-white rounded-full justify-center items-center pt-10' style={{boxShadow: '6px 6px 10px -1px rgba(0,0,0,0.15)'}}>
                  ...
                  <div className={`text-center font-bold text-5xl transition-all ease-in-out duration-1000 ${temperature? +temperature < 25 ? 'text-[#006abc]':+temperature > 32 ? +temperature > 40 ? 'text-red-500': 'text-orange-500' :'text-green-500' : 'text-green-500'}`}>{temperature ? temperature + '°C':''}</div>
                </div>
              </div>
              <div className=''>
                <div className='w-40 h-40 bg-white  rounded-full justify-center items-center pt-6' style={{boxShadow: '6px 6px 10px -1px rgba(0,0,0,0.15)'}}>
                  {/* <Image src={Sun} alt={''} className='w-10 mx-auto'></Image> */}
                  <div className='text-center font-bold'>Sun light</div>
                  <div className='text-center font-bold text-5xl text-red-500'>{sunlight ? sunlight  : ''}</div>
